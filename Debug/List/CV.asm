...
; 0000 004A // Function: Bit7=In Bit6=Out Bit5=Out Bit4=Out Bit3=Out Bit2=In Bit1=Out Bit0=Out
; 0000 004B DDRB=(0<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (0<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(123)
	OUT  0x17,R30
; 0000 004C // State: Bit7=T Bit6=0 Bit5=0 Bit4=0 Bit3=0 Bit2=P Bit1=0 Bit0=0
; 0000 004D PORTB=(0<<PORTB7) | (0<<PORTB6) | (0<<PORTB5) | (0<<PORTB4) | (0<<PORTB3) | (1<<PORTB2) | (0<<PORTB1) | (0<<PORTB0);
	LDI  R30,LOW(4)
	OUT  0x18,R30
; 0000 004E 
...
; 0000 0057 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 0058 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=P Bit2=P Bit1=T Bit0=T
; 0000 0059 PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (0<<PORTD1) | (0<<PORTD0);
	LDI  R30,LOW(12)
	OUT  0x12,R30
; 0000 005A 
...
; 0000 008F GICR|=(1<<INT1) | (1<<INT0) | (1<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xE0)
	OUT  0x3B,R30
; 0000 0090 MCUCR=(1<<ISC11) | (0<<ISC10) | (1<<ISC01) | (0<<ISC00);
	LDI  R30,LOW(10)
	OUT  0x35,R30
; 0000 0091 MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 0092 GIFR=(1<<INTF1) | (1<<INTF0) | (1<<INTF2);
	LDI  R30,LOW(224)
	OUT  0x3A,R30
; 0000 0093 
...
; 0000 00AE // The KS0108 connections are specified in the
; 0000 00AF // Project|Configure|C Compiler|Libraries|Graphic Display menu:
; 0000 00B0 // DB0 - PORTA Bit 0
; 0000 00B1 // DB1 - PORTA Bit 1
; 0000 00B2 // DB2 - PORTA Bit 2
; 0000 00B3 // DB3 - PORTA Bit 3
; 0000 00B4 // DB4 - PORTA Bit 4
; 0000 00B5 // DB5 - PORTA Bit 5
; 0000 00B6 // DB6 - PORTA Bit 6
; 0000 00B7 // DB7 - PORTA Bit 7
; 0000 00B8 // E - PORTB Bit 0
; 0000 00B9 // RD /WR - PORTB Bit 1
; 0000 00BA // RS - PORTB Bit 3
; 0000 00BB // /RST - PORTB Bit 4
; 0000 00BC // /CS1 - PORTB Bit 5
; 0000 00BD // /CS2 - PORTB Bit 6
; 0000 00BE 
; 0000 00BF // Specify the current font for displaying text
; 0000 00C0 glcd_init_data.font=font5x7;
	LDI  R30,LOW(_font5x7*2)
	LDI  R31,HIGH(_font5x7*2)
	ST   Y,R30
	STD  Y+1,R31
; 0000 00C1 // No function is used for reading
; 0000 00C2 // image data from external memory
; 0000 00C3 glcd_init_data.readxmem=NULL;
	LDI  R30,LOW(0)
	STD  Y+2,R30
	STD  Y+2+1,R30
; 0000 00C4 // No function is used for writing
; 0000 00C5 // image data to external memory
; 0000 00C6 glcd_init_data.writexmem=NULL;
	STD  Y+4,R30
	STD  Y+4+1,R30
; 0000 00C7 
; 0000 00C8 glcd_init(&glcd_init_data);
	MOVW R26,R28
	RCALL _glcd_init
; 0000 00C9 
; 0000 00CA 
; 0000 00CB glcd_putimagef(0,0,tasvir,GLCD_PUTOR);
	LDI  R30,LOW(0)
	ST   -Y,R30
	ST   -Y,R30
	LDI  R30,LOW(_tasvir*2)
	LDI  R31,HIGH(_tasvir*2)
	ST   -Y,R31
	ST   -Y,R30
	LDI  R26,LOW(2)
